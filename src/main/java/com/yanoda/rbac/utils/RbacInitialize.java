...
import com.yanoda.rbac.domain.RbacRole;
import com.yanoda.rbac.domain.RbacUser;
...
public class RbacInitialize {
    ...
    public static HashMap<Integer,RbacUser> doRbacUserInit() {
        ConnectionPool pool = ConnectionPool.getInstance();
        Connection connection = pool.getConnection();
        PreparedStatement ps = null;
        ResultSet rs = null;
        HashMap<Integer , RbacUser> rbac = new HashMap<Integer , RbacUser>(); 
